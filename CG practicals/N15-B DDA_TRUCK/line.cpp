...
void render()
{
	...
	dda(15,280,45,360);	//for line drawing
	dda(45,360,85,360);	//for line drawing
	dda(85,360,85,380);	//for line drawing
	dda(85,380,95,380);	//for line drawing
	dda(95,220,95,380);	//for line drawing
	dda(100,380,400,380);	//for line drawing
	dda(400,220,400,380);	//for line drawing
	dda(100,220,400,220);	//for line drawing
	dda(100,220,100,380);	//for line drawing
	dda(15,220,95,220);	//for line drawing
	dda(35,301,87,301);	//for line drawing
	dda(87,259,87,301);	//for line drawing
	dda(35,259,87,259);	//for line drawing
	dda(35,259,35,301);	//for line drawing
	dda(45,291,77,291);	//for line drawing
	dda(77,269,77,291);	//for line drawing
	dda(45,269,77,269);	//for line drawing
	dda(45,269,45,291);	//for line drawing
